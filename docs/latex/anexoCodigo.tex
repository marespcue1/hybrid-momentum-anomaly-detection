...
\textbf{\texttt{01\_obtencion\_datos.ipynb} --- Adquisición de datos}
...
\textbf{\texttt{02\_EDA.ipynb} --- Análisis exploratorio de datos}
...
\textbf{\texttt{03\_ingenieria\_caracteristicas\_DBSCAN.ipynb} --- Construcción de variables y filtrado de anomalías}
...
\textbf{\texttt{04\_k-means\_clustering.ipynb} --- Segmentación en regímenes de mercado}
...
\textbf{\texttt{05\_walkforward\_analysis.ipynb} --- Evaluación del rendimiento de la estrategia}
...
\textbf{\texttt{06\_estudio\_parametros.ipynb} --- Análisis de robustez e importancia de hiperparámetros}
