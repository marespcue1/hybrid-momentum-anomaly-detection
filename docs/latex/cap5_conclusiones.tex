...
\begin{enumerate}
    ...
    robustez mediante bosque aleatorio (\textit{random forest}) reveló 
    que los parámetros con 
    mayor impacto en el rendimiento fuera de muestra son el tamaño de 
    la cartera, el tamaño mínimo para permanecer invertido y la 
    selección del clúster de mercado, que conjuntamente explican más 
    del 70\% de la varianza. La práctica irrelevancia del parámetro de 
    ventana de anomalías sugiere que la presencia del filtro DBSCAN es 
    estructuralmente beneficiosa con independencia de su configuración 
    concreta, lo que valida la arquitectura híbrida propuesta.
...
\begin{itemize}
    ...
    \item \textbf{Incorporación de costes de transacción.} El 
    backtesting realizado asume un entorno de ejecución sin fricciones. 
    En un contexto de aplicación real, los costes de comisiones, el 
    deslizamiento de precios y el impacto de mercado pueden erosionar 
    significativamente los rendimientos. Una línea de trabajo futura 
    consistiría en incorporar modelos realistas de costes de 
    transacción y analizar la sensibilidad de la estrategia a distintos 
    niveles de fricción.
