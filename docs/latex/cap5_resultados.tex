...
\section{Evaluación y Backtesting}
...
\subsubsection{Ventanas temporales y división Train/Test}
...
\subsubsection{Arquitectura del proceso experimental}
...
\subsection{Búsqueda en malla (Grid Search) en datos de entrenamiento}
...
\subsubsection{Distribución del ratio de Sharpe en entrenamiento}
...
\subsubsection{Top 5 combinaciones en entrenamiento}
...
26,63\,\% y una caída máxima de únicamente \(-7,22\,\%\). La
...
\subsubsection{Degradación del rendimiento}
...
característica esperada a cualquier proceso de optimización de
...
\subsubsection{La paradoja del campeón aparente}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{media/wf_03_sharpe_scatter.png}
...
\subsubsection{Análisis de la degradación por ranking}
...
\subsubsection{Identificación de la mejor configuración global}
...
\subsubsection{Curva de capital de la configuración ganadora}
...
\subsubsection{Comparativa con el índice de referencia SPY}
...
\subsubsection{Sensibilidad de parámetros en ventana de prueba}
